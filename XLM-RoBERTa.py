...
class LanguageClassifierBERT:
    ...
    def save_model(self):
        ...
        model_dir = 'Assets/Outputs/Models/XLMRoberta'
        os.makedirs(model_dir, exist_ok=True)
        self.model.save_pretrained(os.path.join(model_dir, 'xlmroberta_model'))
        self.tokenizer.save_pretrained(os.path.join(model_dir, 'xlmroberta_model'))
    ...
    def load_model(self):
        ...
        model_dir = 'Assets/Outputs/Models/XLMRoberta/xlmroberta_model'
        label_encoder_path = 'Assets/Outputs/Models/XLMRoberta/label_encoder.pkl'
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Language Classification with XLM-RoBERTa')
